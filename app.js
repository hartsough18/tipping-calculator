(function () {
  ...
  function showResults(tipAmount, newTotal) {
  ...
  function calculate(tipPercent) {
    ...
    showResults(tipAmount, newTotal);
  }
  ...
  billInput.addEventListener('input', function () {
    var currentPercent = getActiveTipPercent();
    if (currentPercent !== null) {
      calculate(currentPercent);
    }
  });
